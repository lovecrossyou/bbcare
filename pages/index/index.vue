<template>
	<view class="main">
		...
		<view class="content">
			<map style="width: 100%; height: 1100px;" :latitude="latitude" :longitude="longitude" :markers="covers">
			</map>

			<cover-view class="panel">
				<cover-view class="footer_item" @click="goHistory">
					<cover-image src="https://timgsa.baidu.com/timg?image&quality=80&size=b9999_10000&sec=1562844508509&di=cd6010ad4a43b221fc95f1b7c36686d7&imgtype=0&src=http%3A%2F%2Fhbimg.b0.upaiyun.com%2Fff9ef93d75d4cfddf085ab67957e623230d5ce8666f3e-BrCfhJ_fw658" class="footer_item_icon_circle">
					</cover-image>
					<cover-view class="footer_item_title">
						爸爸
					</cover-view>
				</cover-view>
				<cover-view class="footer_item" @click="goHistory">
					<cover-image src="https://ss0.bdstatic.com/70cFvHSh_Q1YnxGkpoWK1HF6hhy/it/u=473036217,3304635291&fm=26&gp=0.jpg" class="footer_item_icon_circle">
					</cover-image>
					<cover-view class="footer_item_title">
						妈妈
					</cover-view>
				</cover-view>
				<cover-view class="footer_item" @click="goMore">
					<cover-image src="https://ss3.bdstatic.com/70cFv8Sh_Q1YnxGkpoWK1HF6hhy/it/u=4088898956,2562357905&fm=26&gp=0.jpg" class="footer_item_icon_circle">
					</cover-image>
					<cover-view class="footer_item_title">
						爷爷
					</cover-view>
			...
			<cover-view class="expert">
				<cover-image class="expert-icon" src="https://ss1.bdstatic.com/70cFvXSh_Q1YnxGkpoWK1HF6hhy/it/u=2190710599,3341195806&fm=27&gp=0.jpg" mode=""></cover-image>
				<cover-view class="expert-prifle" @click="goAngle">
					<cover-view class="expert-top">
						<cover-view class="expert-name">李博医生</cover-view>
						<cover-view class="expert-desc">
							心肺功能专家
						</cover-view>
						<uni-rate disabled="true" value="4"></uni-rate>
					</cover-view>
					<cover-view class="expert-bottom">
						<cover-view class="sick">老人有糖尿病史,高血压</cover-view>
					</cover-view>
				</cover-view>
			</cover-view>
		</view>
